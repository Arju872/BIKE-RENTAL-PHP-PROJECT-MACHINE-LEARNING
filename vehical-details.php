        ...
        <div class="sidebar_widget">
          ...
          <form method="post" action ="bank.php">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="From Date(mm/dd/yyyy)" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="To Date(mm/dd/yyyy)" required>
            </div>
            <div class="form-group">
            ...
            <input type="hidden" name="price_per_day" value="<?php echo $result->PricePerDay; ?>">
            <input type="hidden" name="brand_name" value="<?php echo $result->BrandName; ?>">
            <input type="hidden" name="vehicle_title" value="<?php echo $result->VehiclesTitle; ?>">
